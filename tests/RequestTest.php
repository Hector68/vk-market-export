...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAllProduct()
    {
        ...
        $api->expects($this->any())->method('getResponse')->will($this->returnValue($dataFromVk));


        $transaction = $this->getMockBuilder(RequestTransaction::class)
        ...
        $transaction->expects($this->any())->method('fetchData')->will($this->returnValue($api));
        ...
        $core->expects($this->any())->method('request')->will($this->returnValue($transaction));

        $this->request->setVkApi($core);

        $result = $this->request->getAllGoods();
